...
public class ClusterDetailActivity extends AppCompatActivity implements ClusterDetailContract.View {
    ...
    private ClusterDetailContract.Presenter mPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter = new ClusterDetailPresenter(this, news_ID);
        mError = false;
    ...
    @Override
    public void setPresenter(ClusterDetailContract.Presenter presenter) {
